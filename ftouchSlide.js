...
;(function() {
    ...
    function FTouchSlide(opt, params) {
        this.opt = opt || {},
        this.params = params || {};
        this.params.currentNode = 0;
    }

    FTouchSlide.prototype.init = function() {
        this.initStyle();
        this.renderCss(this.opt.wrapper, {'transform':  'translate3d(0, 0, 0)', 'transition': '0'});
    };

    FTouchSlide.prototype.initStyle = function() {
        var pa = this.params;
        var op = this.opt;
    ...
    FTouchSlide.prototype.ontouchmove = function(ev) {
        ev.preventDefault();
        var baseLength = 0;
        var pa = this.params;
    ...
    FTouchSlide.prototype.ontouchend = function(ev) {
        var pa = this.params;
    ...
    FTouchSlide.prototype.slide = function(num) {
        var pa = this.params;
        var option = this.opt;
        pa.currentNode += num;
    ...
    window.FTouchSlide = FTouchSlide;
